 ...
 */
public class GUI_cronograma extends javax.swing.JFrame {
    ...
    public GUI_cronograma(gestor g) {
        this.g = g;
        aux=new Nodo();
        initComponents();
    ...
    public void mostrarProveedores() {
        ...
        Proveedor proveedor;
         */
        String mes= g.vectorMeses[0].getMes();
        nombreMes.setText(mes);
        /*
        if (g.listaPacientes.size() > 0) {
            int i=0;
            aux = g.listaPacientes.first();
            while (aux != null) {
        ...
        */
        for(int j=0;j<4;j++){
            for (int i=0;i<7;i++){
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 0);
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 1);
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 2);
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 3);
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 4);
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 6);
                jTable1.getModel().setValueAt(g.vectorMeses[0].cronograma[j][i], i, 7);
            }
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lunes", "Martes", "Miercoles", "Jueves", "Sábado", "Domingo"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 490, 230));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 390, 73, -1));
        ...
        jPanel3.add(dniBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, 130, -1));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 310, 60));

        nombreMes.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        getContentPane().add(nombreMes, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 50, 190, 30));
        ...
        jPanel1.add(salir1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 120, 40));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        this.setVisible(false);
        GUI_listaDePacientes cp= new GUI_listaDePacientes(g);
        cp.setVisible(true);
