...
import newpackage.FilaSecuencial;
 ...
 */
public class GUI_recuperarPersonaVacunada extends javax.swing.JFrame {
    gestor g=new gestor();
    public GUI_recuperarPersonaVacunada(gestor g) {
        this.g=g;
        initComponents();
        this.setLocationRelativeTo(null);
        NodoPila perRec=g.vacunados.desempilar();
            Cnombre.setText(perRec.getValor().p.getNombres());
            apellcliente.setText(perRec.getValor().p.getApellidos());
            Cdireccion.setText(perRec.getValor().p.getDireccion());
            Cdni.setText(""+perRec.getValor().p.getDNI());
            Cfecha.setText(perRec.getValor().p.getFechaNac());
            Cdescripcion.setText(perRec.getValor().getDescrpcion());
    ...
    private void initComponents() {
        ...
        getContentPane().add(regcliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 360, 92, -1));
        ...
        getContentPane().add(cancelcli, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 360, -1, -1));
        ...
        jLabel8.setText("RECUPERAR VACUNA");
        ...
        getContentPane().add(salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 360, -1, -1));

        jButton1.setText("Generar Fila sec");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            f.setDescripcion(des);
            JOptionPane.showMessageDialog(null,"Fila Secuencial generada");
            f.addArchivo(p);
        } catch (IOException ex) {
            Logger.getLogger(GUI_recuperarPersonaVacunada.class.getName()).log(Level.SEVERE, null, ex);
        }
        limpiar();
