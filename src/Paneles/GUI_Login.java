...
public class GUI_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SISTEMA DE GESTIÓN DE VACUNAS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //boolean validar=GestorValidacion.validarTamañoLogin(nombre_usuario, pass);
        if (jTextField3.getText() != null && passw.getText() != null) {
            GUI_listaDePacientes administrador = new GUI_listaDePacientes(g);
