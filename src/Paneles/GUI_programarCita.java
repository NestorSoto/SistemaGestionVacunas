...
public class GUI_programarCita extends javax.swing.JFrame {
    gestor g=new gestor();
    public GUI_programarCita(gestor g) {
        this.g=g;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Programar cita");
        ...
        jLabel2.setText("Duracion (en horas)");
        ...
        jPanel1.add(Cduracion, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 170, -1));
    ...
    private void regclienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regclienteActionPerformed
        if (Cnombre.getText() != null && apellcliente.getText() != null && Cdni.getText() != null && Cdireccion.getText() != null && Cfecha.getText() != null) {
            ...
            int horasTotales= Integer.parseInt(Cduracion.getText());
            cita c= new cita();
            c.setDni(dni);
            c.setFecha("1/12/2021");
            c.setHora(horasTotales);
            g.colaDeCitas.encolar(c);
